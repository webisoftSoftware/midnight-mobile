...
data class RuntimeSessionHandle (
    var `id`: kotlin.ULong
    ,
 ...
 * @suppress
 */
public object FfiConverterTypeRuntimeSessionHandle: FfiConverterRustBuffer<RuntimeSessionHandle> {
    override fun read(buf: ByteBuffer): RuntimeSessionHandle {
    ...
    override fun allocationSize(value: RuntimeSessionHandle) = (
            FfiConverterULong.allocationSize(value.`id`) +
            FfiConverterULong.allocationSize(value.`generation`)
    )

    override fun write(value: RuntimeSessionHandle, buf: ByteBuffer) {
...
sealed class MidnightRuntimeException: kotlin.Exception() {
    ...
    companion object ErrorHandler : UniffiRustCallStatusErrorHandler<MidnightRuntimeException> {
        override fun lift(error_buf: RustBuffer.ByValue): MidnightRuntimeException = FfiConverterTypeMidnightRuntimeError.lift(error_buf)
    }
 ...
 * @suppress
 */
public object FfiConverterTypeMidnightRuntimeError : FfiConverterRustBuffer<MidnightRuntimeException> {
    override fun read(buf: ByteBuffer): MidnightRuntimeException {


        return when(buf.getInt()) {
            1 -> MidnightRuntimeException.Unavailable()
            2 -> MidnightRuntimeException.InvalidArgument()
            3 -> MidnightRuntimeException.StaleSession()
            4 -> MidnightRuntimeException.Cancelled()
            5 -> MidnightRuntimeException.StateIncompatible()
    ...
    override fun allocationSize(value: MidnightRuntimeException): ULong {
        return when(value) {
            is MidnightRuntimeException.Unavailable -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is MidnightRuntimeException.InvalidArgument -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is MidnightRuntimeException.StaleSession -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is MidnightRuntimeException.Cancelled -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            is MidnightRuntimeException.StateIncompatible -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
            ...
            is MidnightRuntimeException.ProofFailed -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4UL
            )
    ...
    override fun write(value: MidnightRuntimeException, buf: ByteBuffer) {
        when(value) {
            is MidnightRuntimeException.Unavailable -> {
                buf.putInt(1)
                Unit
...
public object FfiConverterSequenceByteArray: FfiConverterRustBuffer<List<kotlin.ByteArray>> {
    ...
    UniffiLib.uniffi_midnight_mobile_runtime_fn_func_apply_sync_batch(
        ...
        FfiConverterULong.lower(`fromOffset`),
        FfiConverterULong.lower(`toOffset`),
        FfiConverterSequenceByteArray.lower(`payloads`),_status)
}
    )
    }
    ...
    UniffiLib.uniffi_midnight_mobile_runtime_fn_func_open_wallet_session(
        ...
        FfiConverterByteArray.lower(`nightExternalKey`),
        FfiConverterByteArray.lower(`zswapSeed`),
        FfiConverterByteArray.lower(`dustSeed`),
        FfiConverterOptionalByteArray.lower(`checkpoint`),_status)
}
    )
    }
    ...
    UniffiLib.uniffi_midnight_mobile_runtime_fn_func_resume_operation(
        ...
        FfiConverterULong.lower(`operationId`),
        FfiConverterULong.lower(`generation`),
        FfiConverterOptionalString.lower(`networkResultJson`),_status)
}
    )
    }
