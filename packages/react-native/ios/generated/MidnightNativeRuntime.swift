...
#if canImport(MidnightNativeRuntimeFFI)
import MidnightNativeRuntimeFFI
#endif
...
public struct RuntimeSessionHandle: Equatable, Hashable {
    public var id: UInt64
    public var generation: UInt64

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(id: UInt64, generation: UInt64) {
        self.id = id
...
#if compiler(>=6)
extension RuntimeSessionHandle: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeRuntimeSessionHandle: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RuntimeSessionHandle {
        return
            try RuntimeSessionHandle(
                id: FfiConverterUInt64.read(from: &buf),
                generation: FfiConverterUInt64.read(from: &buf)
        )
    }

    public static func write(_ value: RuntimeSessionHandle, into buf: inout [UInt8]) {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRuntimeSessionHandle_lift(_ buf: RustBuffer) throws -> RuntimeSessionHandle {
    return try FfiConverterTypeRuntimeSessionHandle.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeRuntimeSessionHandle_lower(_ value: RuntimeSessionHandle) -> RustBuffer {
    return FfiConverterTypeRuntimeSessionHandle.lower(value)
}


public
enum MidnightRuntimeError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
...
#if compiler(>=6)
extension MidnightRuntimeError: Sendable {}
#endif

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeMidnightRuntimeError: FfiConverterRustBuffer {
    typealias SwiftType = MidnightRuntimeError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> MidnightRuntimeError {
        ...
        case 3: return .StaleSession
        case 4: return .Cancelled
        case 5: return .StateIncompatible
    ...
    public static func write(_ value: MidnightRuntimeError, into buf: inout [UInt8]) {
        switch value {
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMidnightRuntimeError_lift(_ buf: RustBuffer) throws -> MidnightRuntimeError {
    return try FfiConverterTypeMidnightRuntimeError.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeMidnightRuntimeError_lower(_ value: MidnightRuntimeError) -> RustBuffer {
    return FfiConverterTypeMidnightRuntimeError.lower(value)
}
...
public func applySyncBatch(sessionId: UInt64, generation: UInt64, stream: String, fromOffset: UInt64, toOffset: UInt64, payloads: [Data])throws  -> String  {
    ...
    uniffi_midnight_native_runtime_fn_func_apply_sync_batch(
        ...
        FfiConverterUInt64.lower(fromOffset),
        FfiConverterUInt64.lower(toOffset),
        FfiConverterSequenceData.lower(payloads),uniffiCallStatus
    )
})
}
...
public func openWalletSession(configJson: String, nightExternalKey: Data, zswapSeed: Data, dustSeed: Data, checkpoint: Data?)throws  -> RuntimeSessionHandle  {
    ...
    uniffi_midnight_native_runtime_fn_func_open_wallet_session(
        ...
        FfiConverterData.lower(dustSeed),
        FfiConverterOptionData.lower(checkpoint),uniffiCallStatus
    )
})
}
