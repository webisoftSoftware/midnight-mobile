...
| Select | `apps/mobile/modules/expo-midnight-native/runtime-command-types.ts`                                                      | Wallet command type basis; retain the SDK command contract accepted in `PLAN.md` and the three endpoint roles.                                                  |
